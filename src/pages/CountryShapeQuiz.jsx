...
const CountryShapeQuiz = () => {
  ...
  const [elapsed, setElapsed] = useState(() => {
    const start = localStorage.getItem("shapeQuizStartTime");
    if (!start) return 0;
  ...
  return (
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fq-flag-img {
          ...
          filter: invert(1) brightness(1.8) drop-shadow(0 0 12px rgba(255, 255, 255, 0.15));
        }
        ...
        @media (max-height: 720px) {
          .fq-root { padding: 0.5rem; }
          .fq-card { padding: 1rem 1.25rem; }
          .fq-flag-wrapper { aspect-ratio: 2.2 / 1; margin-bottom: 0.75rem; }
          .fq-hint { margin-bottom: 0.75rem; }
          .fq-secondary-actions { margin-top: 0.75rem; padding-top: 0.75rem; }
        }
      ...
      <div className="fq-root">
        ...
        <div className="fq-card">
          {!started ? (
            ...
            <div className="fq-start-screen">
              <div className="fq-start-globe">🗺️</div>
              <h1 className="fq-start-title">Country Shape Quiz</h1>
            ...
            <div className="fq-complete">
              ...
              <div className="fq-complete-score-label">Shapes Identified</div>
              <div
                style={{
                  color: "rgba(255,255,255,0.4)",
                  fontSize: "0.9rem",
            ...
            <>
              ...
              <div className="fq-header">
                <div className="fq-title-container text-white">
                  ...
                  <span className="fq-title">Country Shape Quiz</span>
                </div>
        ...
        <footer className="fq-quiz-footer">
          Shape assets credit:{" "}
          <a
            href="https://github.com/djaiss/mapsicon"
            target="_blank"
            rel="noopener noreferrer"
            className="fq-footer-link"
          >
            mapsicon
          </a>
        </footer>
